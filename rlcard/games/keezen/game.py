...
from rlcard.games.keezen.card import CardState, Suit
...
class Game:
    ...
    def render(self, game_state):
        ...
        player_cards[self.players.index(game_state.move_player)] = player_cards[self.players.index(
            game_state.move_player)] + "<->"
        print("Player " + str(game_state.move_player.player_color[0]) + "'s turn. Move number: "
                ...
                for marble_move in move.marble_moves:
                    ...
                    for hit_marble_move in marble_move.hit_marble_moves:
                        _ = BoardState.put_marble_on_field(hit_marble_move.marble, hit_marble_move.to_field,
                                                           game_state.fields_with_marbles)
                if self.rules.switch_color and self.board.is_color_finished(game_state.move_player.player_color,
                                                                            game_state.fields_with_marbles, self.rules):
                    team_mate_color = game_state.move_player.get_team_mate().player_color
                    if (
                            not self.board.is_color_finished(team_mate_color, game_state.fields_with_marbles,
                                                             self.rules)) and \
    ...
    def is_over(self, game_state):
        ...
        if player_finished:
            if self.rules.switch_color:
                ...
                team_mate_finished = self.board.is_color_finished(team_mate_color, game_state.fields_with_marbles,
                                                                  self.rules)
...
class GameActions:
    ALL_ACTIONS_271 = ['NO', 'DL', 'RU01P0', 'RU01P1', 'RU01P2', 'RU01P3', 'RU02P0', 'RU02P1', 'RU02P2', 'RU02P3',
                       'RU03P0',
                       'RU03P1', 'RU03P2', 'RU03P3', 'RU04P0', 'RU04P1', 'RU04P2', 'RU04P3', 'RU05P0', 'RU05P1',
                       'RU05P2', 'RU05P3', 'RU06P0', 'RU06P1', 'RU06P2', 'RU06P3',
    ...
    ALL_ACTIONS_SIMPLE = ['NO', 'DL', 'RU01P0', 'RU01P1', 'RU01P2', 'RU01P3', 'RU02P0', 'RU02P1', 'RU02P2', 'RU02P3',
                          'RU03P0',
                          'RU03P1', 'RU03P2', 'RU03P3', 'RU04P0', 'RU04P1', 'RU04P2', 'RU04P3', 'RU05P0', 'RU05P1',
                          ...
                          # All SPLIT actions removed
                          'ST01P0', 'ST01P1', 'ST01P2', 'ST01P3',
                          'ST13P0', 'ST13P1', 'ST13P2', 'ST13P3', 'SW11P0O0', 'SW11P0O1', 'SW11P0O2', 'SW11P0O3',
                          'SW11P0T0', 'SW11P0T1', 'SW11P0T2', 'SW11P0T3', 'SW11P1O0', 'SW11P1O1', 'SW11P1O2',
                          'SW11P1O3',
                          'SW11P1T0', 'SW11P1T1', 'SW11P1T2', 'SW11P1T3', 'SW11P2O0', 'SW11P2O1', 'SW11P2O2',
                          'SW11P2O3',
                          'SW11P2T0', 'SW11P2T1', 'SW11P2T2', 'SW11P2T3', 'SW11P3O0', 'SW11P3O1', 'SW11P3O2',
                          'SW11P3O3',
                          'SW11P3T0', 'SW11P3T1', 'SW11P3T2', 'SW11P3T3', 'TC']
